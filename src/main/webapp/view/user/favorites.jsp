...
<title>MY FAVORITES - YG ENTERTAINMENT</title>
...
<body>
	...
	<div class="container-fluid tm-container-content tm-mt-60">
		<div class="row mb-4">
			<h2 class="col-6 tm-text-primary">FAVORITES MADE Diasy</h2>
			...
			<c:forEach items="${videos}" var="video">
				<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
					...
					<div class="d-flex justify-content-between tm-text-gray">
						<span class="tm-text-gray-light">${video.shares} Share</span> <span>${video.views} views</span>
					</div>
				</div>
			</c:forEach>
		</div>
