...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
				...
				<li class="nav-item dropdown"><a class="nav-link"
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
						<a href="#" class="dropdown-item"> <!-- Message Start -->
							<div class="media">
								<img
									src="<c:url value = '/templates/admin/dist/img/user1-128x128.jpg" alt="User Avatar'/>"
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="index3.html" class="brand-link"> <img src=""
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item menu-open"><a
							href="admin/video?action=view" class="nav-link"> <i
								class="nav-icon fas fa-tachometer-alt"></i>
								<p>Video</p>
						</a>
						...
						<div class="card-body">
							<div class="form-group">
								<label>Title</label> <input id="title"
									value="${video != null ? video.tilte: ''}" type="text"
									class="form-control">
							</div>
							<div class="form-group">
								<label>Href</label> <input id="href"
									value="${video != null ? video.href: ''}" type="text"
									class="form-control">
							</div>
							<div class="form-group">
								<label>Description</label> <input id="description"
									value="${video != null ? video.description: ''}" type="text"
									class="form-control">
							</div>
							<div class="form-group">
								<label>Poster</label> <input id="poster"
									value="${video != null ? video.poster: ''}" type="text"
									class="form-control"> <input id="isEdit"
									value="${isEdit}" type="hidden"
									class="form-control">
							</div>
							<div class="form-group">
								<label>Preview</label>
	...
	<script>
		...
		$('#submitBtn').click(function() {
							...
							if(isEdit == true){
								url : '/WebMovie/admin/video?action=edit&href='+hrefOrigin;
							}else{
								url : '/WebMovie/admin/video?action=add';
							}
							var formData = {
							...
							$
									...
									.then(
											function(data) {
												window.location.href = "http://localhost:8080/WebMovie/admin/video?action=view";
											}).fail(function(error) {
										alert("Lỗi");
									});
						});
