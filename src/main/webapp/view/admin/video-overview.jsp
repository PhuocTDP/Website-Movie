...
<body class="hold-transition sidebar-mini layout-fixed">
							...
							<tbody>
								<c:forEach items="${videos}" var="item">
									<tr>
										...
										<td>
										<a href="<c:url value='/admin/video?action=edit&href=${item.href}'/>" type="button" class="btn btn-block btn-primary btn-sm">Edit</a>
	...
	function deleteVideo(href) {
		$.ajax({
			url: '/WebMovie/admin/video?action=delete&href=' + href
		}).then(function(data) {
